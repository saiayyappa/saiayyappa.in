---
author: saiayyappa
pubDatetime: 2024-08-28T13:56:01.000+05:30
modDatetime: 2024-08-28T15:03:00.000+05:30
title: My path to full stack
featured: false
draft: false
tags:
  - full-stack
...
I started my course in `HTML` & `CSS` referring to this [**site**](https://internetingishard.netlify.app/). This gave me much confidence to learn it and pushed me to do practice it at that time. I am big book worm. I wormed my way through those pages and in jiffy, got very accustomed to writing rudimentary startup pages on my own.

Next I started focusing on learning `js`. Btw I loved simplicity and minimalism used in documentation sites, especially [Mozilla Developer Network sites](https://developer.mozilla.org/en-US/docs/Learn/JavaScript). This site was my bloodline to learn javascript and go to reference for years to come. I still use it to understand how things work in `js`. Learn `js`, it's the silver bullet to all the frameworks and what not products they build with `js`.
